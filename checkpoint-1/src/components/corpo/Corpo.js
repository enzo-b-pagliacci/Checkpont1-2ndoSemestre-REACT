      ...
      <div className="site_content">
        <main className="posts.col__list">
          ...
          <div className="post__content">
            ...
            <p  className="p-one">Por ser uma doença nova, a Covid-19 ainda não foi compreendida totalmente pela comunidade médica global. Os conhecimentos sobre a doença estão em constante atualização, incluindo os sintomas e os impactos para a saúde a curto e longo prazos.</p>
            <p className="p-one">
